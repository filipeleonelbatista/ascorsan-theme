        ...
        <div class="container" style="border: solid 2px #006c8a; border-radius: 15px; margin: 15px auto; padding: 30px 0;">
            ...
            <div id="video-content" class="row mt-4" style="padding 30px;">
                <div class="col-sm text-center">
                    <?php if (get_theme_mod("youtube-video_index") != '') : ?>
                        <iframe width="420" height="315" src="<?php echo str_replace("watch?v=","embed/",get_theme_mod("youtube-video_index")); ?>" frameborder="0" allowfullscreen></iframe>
                        <?php else : ?>
