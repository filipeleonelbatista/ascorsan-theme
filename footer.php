      ...
      <div class="col-xs-12 col-sm-3 col-md-3">
        ...
        <div class="ml-0 pt-0">
          <ul class="list-unstyled quick-links">
            ...
            <li><a href="https://api.whatsapp.com/send?phone=55<?php echo get_theme_mod('telefone3', '51 99289.7516'); ?>/" target="_blank"><i class="fab fa-whatsapp"></i><?php echo get_theme_mod('telefone3', '51 99289.7516'); ?></a></li>
