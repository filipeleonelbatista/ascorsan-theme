...
function asc_remove_footer_admin () {
	echo '<span id="footer-thankyou">Tema Ascorsan - Versão 1.3<br> Desenvolvido por <a href="https://leonelinformatica.com.br/" target="_blank">Leonel Informática</a></span>';
}
...
if (!function_exists('wp_render_title_tag')){
    function asc_render_title(){
		...
		if ( is_singular() ) {
			...
			<meta itemprop="description" content="<?php print($des_post); ?>">
			<meta itemprop="image" content="<?php print($image) ?>">

			<!-- Open Graph Facebook -->
			<meta property="og:title" content="<?php print($post->post_title); ?>">
			<meta property="og:description" content="<?php print($des_post); ?>"/>
			...
			<meta name="twitter:description" content="<?php print($des_post); ?>">
...
// function asc_adicionar_seo_head() {
// 	global $post;
...
// 		$resumo = mb_substr(strip_shortcodes($post->post_content), 0, 200, 'utf8');
// 		$image = get_the_post_thumbnail_url($post->ID,'full');
...
// 		echo '<!-- SEO Geral -->' . "\n";
// 		echo '<meta name="title" content="' . bloginfo( "name" ) . '">' . "\n";
// 		echo "<meta name='description' content='" . $des_post . "' />" . "\n";
// 		echo '<link rel="canonical" href="' . home_url() .'">' . "\n";
// 		echo '<meta name="author" content="' . bloginfo( "name" ) . '">' . "\n";
// 		echo '<meta name="robots" content="index">' . "\n";

// 		echo '<!-- Google+ / Schema.org -->' . "\n";
// 		echo '<meta itemprop="name" content="' . $post->post_title . '">' . "\n";
// 		echo '<meta itemprop="description" content="' . $resumo . '">' . "\n";
// 		echo '<meta itemprop="image" content="' . get_permalink( $post->ID ) . '">' . "\n";
...
// 		echo '<meta name="twitter:url" content="' . get_permalink( $post->ID ) . '">' . "\n";
...
//     }
// }
// add_action( 'wp_head', 'asc_adicionar_seo_head');
