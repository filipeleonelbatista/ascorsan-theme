...
<script>
    window.onload = function() {
        ...
        if (sessionStorage.getItem("modal-aviso") == null) {
            console.log(sessionStorage.getItem("modal-aviso"))
            setTimeout(function() {
...
<?php if (get_theme_mod("add-aviso-atualizacao-cadastral")) : ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!-- <h5 class="modal-title">Atualização Cadastral</h5> -->
                        <h5 class="modal-title">Formulário Assembleia Geral Extraordinária</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                       <!--  <p><b>Atualize seu cadastro com a Ascorsan</b></p> -->
                        <p><b>Preencha com seus dados para receber o link de acesso para a assembleia do dia 8 de dezembro de 2021.</b></p>
                        <?php
