      ...
      <div class="row d-flex align-items-center">
          ...
          <a href="<?php echo get_home_url(); ?>">
            <?php 
                ...
                if(has_custom_logo()){
                    ...
                    echo "<h1 class='text-center' style='color: white;'>" .get_bloginfo('name'). "</h1>";
                    echo "<p class='text-center' style='color: white;'>" .get_bloginfo('description'). "</p>";
                }
        ...
        <div class="col-sm-4 d-flex justify-content-center">
          <div class="row mb-2 mt-2 d-flex align-items-center">          
            <?php if(get_theme_mod("link") != ""): ?>
            <a target="_blank" href="<?php echo get_theme_mod('link'); ?>" class="btn btn-outline-light-ascorsan"><?php echo get_theme_mod('titulolink'); ?></a>
            <a class="v-divider"></a>
            <?php endif; ?>
            <a target="_blank" href="https://www.instagram.com/<?php echo get_theme_mod('instagram','ascorsan'); ?>"><i class="fab fa-instagram fa-lg"></i></a>
            <a target="_blank" href="https://www.facebook.com/<?php echo get_theme_mod('facebook','AscCorsan'); ?>"><i class="fab fa-facebook fa-lg"></i> </a>          
